...
@ContextConfiguration(classes = ClientServer_WithCodeAndSerializerOnServerIT.HazelcastSessionConfig.class)
@SuppressWarnings("resource")
class ClientServer_WithCodeAndSerializerOnServerIT
        extends AbstractHazelcastIndexedSessionRepositoryIT {

    private static final Logger LOGGER = LoggerFactory.getLogger(
            ClientServer_WithCodeAndSerializerOnServerIT.class);
